...
// 마비노기 API 카테고리 목록 (실제 API 호출 이름)
const categories = [
  // 근거리 무기
  { id: 'blade', name: '검', mainCategory: '근거리 장비' },
  { id: 'blunt', name: '둔기', mainCategory: '근거리 장비' },
  { id: 'lance', name: '랜스', mainCategory: '근거리 장비' },
  { id: 'axe', name: '도끼', mainCategory: '근거리 장비' },
  { id: 'knuckle', name: '너클', mainCategory: '근거리 장비' },
  { id: 'crossbow', name: '석궁', mainCategory: '원거리 장비' },
  { id: 'bow', name: '활', mainCategory: '원거리 장비' },
  { id: 'dualgun', name: '듀얼건', mainCategory: '원거리 장비' },
  { id: 'shuriken', name: '수리검', mainCategory: '원거리 장비' },
  { id: 'cylinder', name: '실린더', mainCategory: '마법 장비' },
  { id: 'wand', name: '원드', mainCategory: '마법 장비' },
  { id: 'staff', name: '스태프', mainCategory: '마법 장비' },
  
  // 방어구
  { id: 'light_armor', name: '경갑옷', mainCategory: '갑옷' },
  { id: 'heavy_armor', name: '중갑옷', mainCategory: '갑옷' },
  { id: 'robe', name: '로브', mainCategory: '방어 장비' },
  { id: 'helmet', name: '투구/모자', mainCategory: '방어 장비' },
  { id: 'glove', name: '장갑', mainCategory: '방어 장비' },
  { id: 'shoes', name: '신발', mainCategory: '방어 장비' },
  { id: 'shield', name: '방패', mainCategory: '방어 장비' },
  
  // 액세서리
  { id: 'earring', name: '귀걸이', mainCategory: '액세서리' },
  { id: 'ring', name: '반지', mainCategory: '액세서리' },
  { id: 'necklace', name: '목걸이', mainCategory: '액세서리' },
  
  // 특수 장비
  { id: 'ecostone', name: '에코스톤', mainCategory: '특수 장비' },
